...
Souvent, on *step* dans le code, c'est-à-dire qu'on suit les flux de contrôle, ou *control flow* en anglais. Pour faire cela, on se sert soit de l'IDE soit, plus simple, des sorties console.

Une fois l'étape plus ou moins identifiée dans le code, on peut s'attaquer au problème à la racine ou bien, dans le cas contraire, *patcher* juste le symptôme, surtout en cas d'urgence.
