...
export const sidePanelSelectableCategories = ["article", "project", "about"] as const;
...
const SidePanel: FunctionComponent<SidePanelProps> = ({ selected, onSelectedChange }) => (
    ...
    <div tw="flex-grow">
      {sidePanelSelectableCategories.map(category => (
        <div
          ...
          css={[tw`text-white cursor-pointer hover:text-lychee`, category === selected && tw`text-lychee`]}
        >
