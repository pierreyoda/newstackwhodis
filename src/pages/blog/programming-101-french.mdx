...
Je déconseille fortement toute forme d'aide de ces outils pour un développeur expérimenté, d'autant plus que ces **LLM** (Large Language Model) ont une forte tendance à "halluciner" (c'est bien le terme technique) des variables, fonctions ou pire qui n'existent pas.∏
