...
I also do **a lot** of Rust for my [personal projects](https://github.com/pierreyoda), having started from the beta version.
...
**EDIT 2**: due to bug(s) in mdsvex and/or SvelteKit, I had to switch back to Next.js.
